 ...
 * Type class contain
 *  The trait itself
 *  Implementations of the trait, implicit
 *  Implicit parameters of those implementations
 *  Extension methods, implicit
 */
//Helper ADT
sealed trait Json
...
object JsonWriterInstances{
  ...
  // a JsonWriter[T]
  implicit def jsonWriterOptionInstance[T](implicit jw:JsonWriter[T]):JsonWriter[Option[T]]={
