...
object ScratchPad {
  ...
  /**
   * Αν Parent<-Child1<-Child2 τοτε αν σου γυρισω F[Child1] μπορεις να το ερμηνευσεις ως F[Parent]
   * Αν ομως Parent<-Child1<-Child2 τοτε, αν δεχομαι F[Child1] δεν μπορεις αν μου δωσεις F[Parent] ! μπορεις
   *        Να μου δωσεις ειτε Child1 είτε Child2
   * @tparam A
   */
